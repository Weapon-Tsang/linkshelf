...
Use this prompt in the next Codex window:

```text
This is the continuation window for the LinkShelf MVP.
...
Workspace:
/Users/weapon_tsang/Documents/linkshelf/.worktrees/linkshelf-mvp

Branch:
codex/linkshelf-mvp

Project Operating System remains active:
...
Sprint 26 should be complete. First output a Project Health Report and confirm
